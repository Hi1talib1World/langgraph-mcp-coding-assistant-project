...
Provides isolated execution with network egress blocking and memory/time bounds.
"""
...
class SandboxedExecutor:
    ...
    def _check_docker(self) -> bool:
        """Verifies if docker CLI and daemon are accessible."""
    ...
    def run_command(
        ...
        """
        Executes command in Docker container if available, or isolated fallback process if not.
        """
...
if __name__ == "__main__":
    ...
    executor = SandboxedExecutor(workspace_dir=".")
    print("Docker available:", executor.has_docker)
    res = executor.run_command([sys.executable, "-c", "print('Sandbox Test execution output!')"])
    print("Result:", res)
